...
<div id="about">
<h1>
${ _("Prelude version %s") % version.__version__ }
</h1>
...
<div id="about_contact" class="panel">
  <div>
     <b>${ _("Contact") }</b>
  ...
  <p id="copyright">Copyright &copy; 2004-2016 CS Communication &amp; Syst&egrave;mes. All rights reserved.</p>
